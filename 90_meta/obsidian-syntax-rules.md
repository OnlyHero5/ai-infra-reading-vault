...
| `sglang_reading/PLAN.md` | SGLang 总计划 |
| `slime_reading/Slime-PLAN.md` | Slime 总计划 |
| `sglang_reading/progress.md` | SGLang 进度 |
| `slime_reading/Slime-progress.md` | Slime 进度 |
...
目录↔专题映射（**仅维护者**）：`90_meta/sglang-module-dir-map.md`、`90_meta/slime-module-dir-map.md`
...
[[Slime-progress]]                 ← Slime 进度（勿用 [[progress]]）
...
| `90_meta/audit_moc.py` | SGLang 六件套审计 |
| `90_meta/audit_slime_moc.py` | Slime 六件套审计 |
| `90_meta/fix_mermaid_newlines.py` | Mermaid 换行修复 |
| `90_meta/fix_slime_obsidian.py` | Slime 双链批量修复 |
| `90_meta/sglang-module-dir-map.md` | SGLang 目录↔专题（维护者） |
| `90_meta/slime-module-dir-map.md` | Slime 目录↔专题（维护者） |
