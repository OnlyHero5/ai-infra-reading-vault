...
```python
## 来源：slime/backends/megatron_utils/loss.py L510-L511, L230–279（_build_shifted_tokens 核心）
...
```python
## 来源：slime/backends/megatron_utils/loss.py L513-L525, L40–51
...
```python
## 来源：slime/backends/megatron_utils/loss.py L527-L546
...
```python
## 来源：slime/backends/megatron_utils/loss.py L552-L561, L216–227（_allgather_cp_redistribute 尾部）
...
```python
## 来源：slime/backends/megatron_utils/loss.py L456-L465
    else:
        # cp1
        offset = 0
...
```python
## 来源：slime/backends/megatron_utils/loss.py L720-L724, ppo_utils.py L361–368
