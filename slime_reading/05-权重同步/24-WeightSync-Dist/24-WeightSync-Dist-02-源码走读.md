...
```python
## 来源：slime/backends/megatron_utils/update_weight/common.py L208-L219
...
```python
## 来源：slime/backends/megatron_utils/update_weight/update_weight_from_distributed.py L57-L92
...
```python
## 来源：slime/backends/megatron_utils/update_weight/update_weight_from_distributed.py L216-L238
...
```python
## 来源：slime/backends/megatron_utils/update_weight/hf_weight_iterator_direct.py L24-L33
...
```python
## 来源：slime/backends/megatron_utils/update_weight/hf_weight_iterator_direct.py L116-L133
...
```python
## 来源：slime/backends/megatron_utils/update_weight/common.py L87-L91
    for handle in handles:
