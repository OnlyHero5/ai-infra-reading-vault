...
# Slime 00 · 零基础先修：Ray 与 Megatron

> 面向**不熟悉分布式训练 / RL 后训练**的读者  
> 读完本篇，再进入 [[Slime-01-项目总览]]、[[全链路RL训练追踪]] 与 [[Slime-04-导读路径]]  
...
- 之后的主循环见 [[全链路RL训练追踪]]，入口专题见 [[02-训练主循环-00-MOC]]。
...
深读：[[06-PlacementGroup-01-核心概念]]、[[09-EngineTopology-01-核心概念]]。
...
- 深读：[[07-RayTrainGroup-01-核心概念]]、[[17-Megatron-Actor-Init-01-核心概念]]。
...
- 参数专题：[[03-Arguments-Ray-00-MOC]]、[[04-Arguments-TrainRollout-00-MOC]]。
...
- 新手先掌握 DP/TP/PP 即可；CP/EP/VPP 可以等读 [[23-CP-RoutingReplay-00-MOC]]、[[18-Model-Init-00-MOC]] 时再深入。
...
- 深读：[[19-Train-Step-01-核心概念]]、[[20-Train-Data-01-核心概念]]。
...
- 深读：[[21-Loss-Advantages-01-核心概念]]、[[22-Loss-Policy-01-核心概念]]。
...
- NCCL 路径见 [[24-WeightSync-Dist-00-MOC]]。
- 磁盘路径见 [[25-WeightSync-Disk-00-MOC]]。
- Megatron checkpoint 转 HF 见 [[26-Checkpoint-M2HF-00-MOC]]。
...
全链路RL训练追踪
  ↓
Slime-04-导读路径 Step 1-6
  ↓
06-PlacementGroup / 07-RayTrainGroup
  ↓
17-Megatron-Actor-Init / 19-Train-Step
  ↓
21-Loss-Advantages / 22-Loss-Policy / 24-WeightSync-Dist
```

| 阶段 | 目标 | 文档 |
|------|------|------|
| 0 | 建立 Ray/Megatron 直觉 | 本篇 |
| 1 | 看懂 Slime 三角架构 | [[Slime-01-项目总览]] |
| 2 | 串起 RL 闭环 | [[全链路RL训练追踪]] |
| 3 | 看 Ray 如何排 GPU | [[06-PlacementGroup-00-MOC]]、[[07-RayTrainGroup-00-MOC]] |
| 4 | 看 Megatron 如何训练 | [[17-Megatron-Actor-Init-00-MOC]]、[[19-Train-Step-00-MOC]] |
| 5 | 看 loss 与权重同步 | [[21-Loss-Advantages-00-MOC]]、[[24-WeightSync-Dist-00-MOC]] |

### Comment

- 如果你还不熟悉 SGLang 推理侧，先读 [[00-零基础先修]] 与 [[全链路请求追踪]]。
- 如果只想跑通 Slime 主流程，本篇 + [[全链路RL训练追踪]] + [[Slime-04-导读路径]] 足够建立全局地图。

---

## 下一步

→ 从零读 Slime：[[Slime-01-项目总览]]  
→ 想看一轮训练怎么跑：[[全链路RL训练追踪]]  
→ 想先补 Ray：[[06-PlacementGroup-00-MOC]]、[[07-RayTrainGroup-00-MOC]]  
→ 想先补 Megatron：[[17-Megatron-Actor-Init-00-MOC]]、[[19-Train-Step-00-MOC]]
