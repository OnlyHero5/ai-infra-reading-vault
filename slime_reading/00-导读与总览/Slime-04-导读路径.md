...
建议顺序：Step 0 补 Ray/Megatron 直觉 → Step 1–6 建立全局视图 → Step 7–10 走通训练闭环 → Step 11–12 定制与生态。

---

## Step 0 · Ray / Megatron 零基础先修
...
**Comment：** 先修文档只建立直觉：Ray 管资源与远程进程，Megatron 管训练并行。源码深读从 Step 4 与 Step 8 开始。
...
| order | title | 对应专题 | 文档 |
|-------|-------|----------|------|
| 0 | Ray/Megatron 先修 | 总结层 | [[Slime-00-零基础先修]] |
...
- [[Slime-90-总结复盘-04-checkpoint]] — 自测清单
