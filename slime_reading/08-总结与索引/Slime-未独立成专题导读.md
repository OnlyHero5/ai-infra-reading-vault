...
|---------------|----------------|-------------------------|------|
| **megatron_server.py** | 辅助 HTTP 服务，非 train 主循环 | [[08-总结与索引-07-可观测与CI]] 摘要 · [[17-Megatron-Actor-Init-04-关键问题]] | 浅 |
| **CI / 生产可观测** | 测试 harness 非 RL 闭环 | [[08-总结与索引-07-可观测与CI]] · `tests/test_qwen3_4B_ppo.py`（导读路径 Step 12） | 浅–中 |
...
| 顺序 | 文档 | 关注点 |
|------|------|--------|
| 1 | [[08-总结与索引-07-可观测与CI]] | 文件地图中的 `megatron_server.py` 定位 |
...
| 3 | [[08-总结与索引-04-导读路径]] Step 12 | e2e 测试阅读 |
