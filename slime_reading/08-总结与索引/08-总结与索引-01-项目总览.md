...
2. 按 [[08-总结与索引-04-导读路径]] 12 步 tour 顺序阅读
3. 遇到术语查 [[Slime-术语表]]；需要全局定位查 [[08-总结与索引-05-文件地图]]
