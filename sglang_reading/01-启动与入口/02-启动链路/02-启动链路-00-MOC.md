...
> **阶段 I · 启动与入口** | Git：`70df09b83363e0127b43c83a6007d3938f815b2d` 
...
| 02 | [[02-启动链路-02-源码走读]] | **主文档**：argv → ServerArgs → run_server 按调用顺序精读 |
| 03 | [[02-启动链路-03-数据流与交互]] | argv → ServerArgs → 四路分发的数据流 |
| 04 | [[02-启动链路-04-关键问题]] | FAQ、易错点、与旧入口对比 |
